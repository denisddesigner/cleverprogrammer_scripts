...
def random_computer_choice(choices):
...
def choice_result(human_choice, computer_choice):
    ...
    if human_choice == 'rock' and computer_choice == 'paper':
        return COMPUTER_SCORE == COMPUTER_SCORE + 1
    elif human_choice == 'rock' and computer_choice == 'scissors':
        return HUMAN_SCORE == HUMAN_SCORE + 1
...
def rock():
    ...
    human_choice = 'rock'
    computer_choice = random_computer_choice(choices)
