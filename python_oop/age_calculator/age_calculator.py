...
# create init method
# 2 attributes (name, birthdate)
# create an object from the person's class 
...
def calculate_age():
	...
	print(day_entry.get())
	person = Person("Denis", datetime.date(int(year_entry.get()),
										  int(month_entry.get()),
										  int(day_entry.get())))
	print(person.age())
...
image = Image.open('/Users/denism/Documents/cleverprogrammer/python_oop/images/age.jpeg')
...
#denis = Person("Denis", datetime.date(1988, 12, 18))
#print(denis.name)
#print(denis.birthdate)
#print(denis.age())
